...
class WalletHeaderView: UIView {
  ...
  private let titleLabel = UILabel().then {
    ...
    $0.text = Strings.BraveRewardsWalletHeaderTitle
  }
  ...
  let grantsButton = ActionButton(type: .system).then {
    ...
    $0.setTitle(Strings.BraveRewardsWalletHeaderGrants, for: .normal)
  ...
  let addFundsButton = UIButton(type: .system).then {
    $0.setTitleColor(UIColor(white: 1.0, alpha: 0.75), for: .normal)
    $0.setTitle(Strings.BraveRewardsAddFunds, for: .normal)
  ...
  let settingsButton = UIButton(type: .system).then {
    $0.setTitleColor(UIColor(white: 1.0, alpha: 0.75), for: .normal)
    $0.setTitle(Strings.BraveRewardsSettings, for: .normal)
