...
class TipsDetailViewController: UIViewController {
  ...
  private func loadData() {
    ...
    nextContributionDateView.label.text = Date.dateStringFrom(intervalSince1970: state.ledger.autoContributeProps.reconcileStamp)
...
extension TipsDetailViewController: UITableViewDataSource, UITableViewDelegate {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    case .tips:
      ...
      switch tip.category {
      case .oneTimeTip:
        cell.typeNameLabel.text = Strings.OneTimeText + Date.dateStringFrom(intervalSince1970: tip.reconcileStamp)
      case .recurringTip:
