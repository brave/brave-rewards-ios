...
void NativeLedgerClient::GetExcludedPublishersNumberDB(ledger::GetExcludedPublishersNumberDBCallback callback) {
  [bridge_ getExcludedPublishersNumberDB:callback];
}
...
void NativeLedgerClient::OnPanelPublisherInfo(ledger::Result result, std::unique_ptr<ledger::PublisherInfo> arg1, uint64_t windowId) {
  [bridge_ onPanelPublisherInfo:result arg1:std::move(arg1) windowId:windowId];
}
...
void NativeLedgerClient::SaveActivityInfo(std::unique_ptr<ledger::PublisherInfo> publisher_info, ledger::PublisherInfoCallback callback) {
...
void NativeLedgerClient::SaveNormalizedPublisherList(const ledger::PublisherInfoListStruct & normalized_list) {
  [bridge_ saveNormalizedPublisherList:normalized_list];
}
void NativeLedgerClient::SavePendingContribution(const ledger::PendingContributionList & list) {
  [bridge_ savePendingContribution:list];
}
void NativeLedgerClient::SavePublisherInfo(std::unique_ptr<ledger::PublisherInfo> publisher_info, ledger::PublisherInfoCallback callback) {
